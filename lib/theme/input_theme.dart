...
class InputTheme {
  static InputDecorationTheme defaultInputDecorationTheme =
    ...
    //     // color: Color.fromARGB(255, 40, 75, 248),
    //     // borderSide: BorderSide(color: Color.fromARGB(255, 40, 75, 248)),
    //     //원래 grey
    //     ),
    ...
    contentPadding: const EdgeInsets.symmetric(horizontal: 30.0), //입력필드 양쪽 여백
    filled: true,
    ...
    enabledBorder: OutlineInputBorder(
      ...
      borderSide: const BorderSide(color: Color.fromARGB(40, 31, 31, 31)),
    ),
  );
}
